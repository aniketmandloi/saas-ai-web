          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  Launch Your SaaS Faster With AI Capabilities
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                ...
                >
                  A complete starter kit for building production-ready SaaS
                  applications with Next.js, Prisma, Tailwind CSS, and AI
                  integration.
                </TextEffect>
